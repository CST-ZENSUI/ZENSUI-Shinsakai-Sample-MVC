...
{
    public class Syuppin
    {
        public int RowNo { get; set; }
        public int SyuppinNo { get; set; }
        ...
        public string? SyuppinKubun { get; set; }
        ...
        public string? HozonZyouken { get; set; }
        public string? SyoumiKigen { get; set; }
        public string? Tabekata { get; set; }
        public string? SyouhinTokutyou { get; set; }
        public string? KannouTokusei { get; set; }
        public string? Tyakusou { get; set; }
